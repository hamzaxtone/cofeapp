...
import processinggOrder from "../../assets/processingOrder.svg";
        ...
        <div className="bg-white rounded-[12px] px-[0px] lg:px-[24px] py-[0px] lg:py-[30px]">
          <div className="flex justify-center items-center py-[10px]">
            <div className="bg-[#D8D8D833] w-[112px] h-[112px] flex flex-col justify-center items-center rounded-[50%]">
              <Image src={processinggOrder} alt="processinggOrder" />
            </div>
          </div>
          ...
          <div className="flex justify-between my-[7px] stepper">
            ...
            <div className="step w-[162px] h-[6px] rounded-[8px] bg-[#08BFB0]  mx-[8px]"></div>
            <div className="step w-[162px] h-[6px] rounded-[8px] bg-[#86CDD733] mx-[8px]"></div>
            <div className="step w-[162px] h-[6px] rounded-[8px] bg-[#86CDD733] mx-[8px] mr-[0]"></div>
          </div>
          <div
            className={`${styles.trackingNote} flex lg:justify-start justify-center  items-center px-[16px] py-[15px] bg-[#F3F2FC] rounded-[10px] mt-[24px] mb-[48px]`}
          >
            <Icon
              icon="icon-deliver"
              className={`iconDeliverCustomClass text-[#000000] text-[12px] ${
                lang == "en" ? " mr-[9px]" : "ml-[9px]"
              } flex items-center`}
            />
            <span className="text-[#4D4D4D] text-[14px]">
              Tracking will show after shipping.
            </span>
          </div>
